...
function RageUI.VehiclePreview(Vehicle)
    ...
    if CurrentMenu ~= nil then
        if CurrentMenu() then
            RenderSprite('RageUI', Vehicle, CurrentMenu.X, CurrentMenu.Y + 560, TextPanels.Background.Width + CurrentMenu.WidthOffset, TextPanels.Background.Height + 200, 0, 255, 255, 255, 255);
